...
<div class="eb-post" data-blog-posts-item data-id="<?php echo $post->id;?>">
	...
	<?php if (($this->config->get('layout_avatar') && $this->params->get('post_author_avatar', true)) || ($post->isTeamBlog() && $this->config->get('layout_teamavatar')) || $this->params->get('post_type', true) || $post->isFeatured()) { ?>
		<div class="eb-post-side <?php echo !$this->config->get('layout_avatar') || !$this->params->get('post_author_avatar', true) ? ' no-avatar' : '';?>">
			...
			<div class="eb-post-meta-team eb-post-author-avatar team">
