...
<div class="eb-featured <?php echo $this->isMobile() ? 'is-mobile' : '';?>">
	<div id="eb-showcases" class="eb-showcases carousel slide mootools-noconflict"  data-featured-posts>
		...
		<div class="carousel-inner">
            ...
            <div class="eb-showcase-content-left">
              <div class="col-cell " >
                <?php if ($this->params->get('featured_post_author_avatar', true)) { ?>
                  <!--TODO: pull-left & pull-right settings for author avatar-->
                  <a href="<?php echo $post->author->getProfileLink(); ?>" class="eb-avatar-sm pull-left">
                    <img src="<?php echo $post->author->getAvatar();?>" class="eb-avatar eb-avatar-sm" width="50" height="50" alt="<?php echo $this->html('string.escape', $post->author->getName());?>" />
                  </a>
                <?php } ?>
              </div>
            ...
            <div class="eb-showcase-content-right">
          ...
          <div class="eb-showcase-more pull-right">
